...
import { SVG_NAMESPACE } from '@rssaini01/annotorious/src/util/SVG';
import { drawShape, shapeArea, svgFragmentToShape, parseRectFragment } from '@rssaini01/annotorious/src/selectors';
...
import { 
  ...
  svgPathToPolygons,
  pointInLine
} from '@rssaini01/annotorious/src/util/Geom2D';
...
export default class AnnotationStore {
  ...
  getAnnotationAt = (x, y, scale) => {
    ...
    const exactHits = idxHits.filter(annotation => {
      ...
      } else if (selectorType === 'TextSelector') {
        //TODO: Impl functionality for TextSelector
        console.warn("TextSelector functionality is not implemented.");
      }
      else {
